...
namespace PrintSoftWeb.Controllers
{
    ...
    public class NewDashController : Controller
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<NewDashController> _logger;
        private readonly IStringLocalizer<NewDashController> _localizer;
        public NewDashController(ILogger<NewDashController> logger, IStringLocalizer<NewDashController> localizer, IConfiguration configuration)
        {
