...
{
    public class HighlightsNewController : Controller
    {
        private readonly HttpClient _httpClient;
        private readonly ILogger<HighlightsNewController> _logger;
        private readonly IStringLocalizer<HighlightsNewController> _localizer;
        private Microsoft.AspNetCore.Hosting.IHostingEnvironment Environment;
        private IConfiguration Configuration;
        public HighlightsNewController(ILogger<HighlightsNewController> logger, IStringLocalizer<HighlightsNewController> localizer, IConfiguration configuration, Microsoft.AspNetCore.Hosting.IHostingEnvironment _environment)
        {
                    ...
                    using (SqlConnection con = new SqlConnection(conString))
                    {
                        using (SqlBulkCopy sqlBulkCopy = new SqlBulkCopy(con))
                        {
                           ...
                           // sqlBulkCopy.ColumnMappings.Add("Y-T-D Growth(%)", "h_ytd");
                            ...
                            sqlbc.ColumnMappings.Add("Growth", "y_growth");
                            ...
                            sqlBulkCopy1.ColumnMappings.Add("Growth (%) Change", "e_growth");
                            ...
                            sqlBulkC1.ColumnMappings.Add("Self Set Target", "m_selftarget");
                            sqlBulkC1.ColumnMappings.Add("Achievement of Target", "m_tobeachieved");
                ...
                using (MemoryStream memoryStream = new MemoryStream())
                {
                    ...
                    using (var workbook = new XLWorkbook())
                    {
                       ...
                       // worksheet.Cell(currentRow, 5).Value = "COL4";
                        worksheet.Cell(currentRow, 5).Value = "M-O-M Growth(%)";
                        worksheet.Cell(currentRow, 6).Value = "Y-O-Y Growth(%)";
                        ...
                        worksheet1.Cell(currentRow1, 4).Value = "Y-O-Y Growth(%)";
                        ...
                        worksheet3.Cell(currentRow3, 5).Value = "Self Set Target";
                        worksheet3.Cell(currentRow3, 6).Value = "Achievement of Target";
                        ...
                        worksheet4.Cell(currentRow4, 4).Value = "Growth";
                        ...
                        worksheet5.Cell(currentRow5, 4).Value = "Growth (%) Change";
