...
{ 
    public class HighlightsRepository : IHighlightsRepository
    {
        ...
        public HighlightsRepository(DapperContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Highlights(Highlights model)
        {
            using (var connection = _context.CreateConnection())
            {
                ...
                try
                {
                    ...
                    var queryResult = await connection.QueryMultipleAsync("proc_Highlights", SetParameter(model), commandType: CommandType.StoredProcedure);
